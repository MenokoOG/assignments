...
// the event targets do need to be handled carefully
...
// if we use the same insertBefore() in the editButton functionality to keep the formatting (that we use in the other js files), that changes the order of the buttons, so then the third button is actually not the save button, and we're clicking on the button that says 'save' and it's deleting it