...
const btnClick = button.addEventListener("click", () => output.innerHTML = `You've submitted ${input.value}`)
...
function unshift(array, ...items) {
    return [...items, ...array].sort();
  }

const originalArry = ["a","b", "c", "d", "e"]
const newArray = unshift(originalArry, "f", "g", "h" )
